...
#                                                                             
# PROGRAMMER: Mohammed AbdulQader Albannai
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key ,value in results_stats_dic.items():
        if results_stats_dic[key[0]] == "p":
            print("They key is {}, with the value of {}".format(results_stats_dic[key], results_stats_dic[key][value]))                   
    ...
    if (print_incorrect_breed and 
        ...
        for key in results_dic:
            if results_dic[key][3] != results_dic[key][4] or results_dic[key][4] != results_dic[key][3]:
                print("Pet label is {}, and the Classifier Label is {}".format(results_dic[key][3], results_dic[key][4]))                 
    if (print_incorrect_breed and 
        (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']) 
       ):
        print("\nINCORRECT Dog Breed Assignment:")
